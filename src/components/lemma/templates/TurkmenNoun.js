		 ...
		 <tr>
		  ...
		  <td className="table-cell">
		   <span opt_features="[]" req_features='["SG","N"]'>
		    <Wordform features={['SG', 'N']} optional_features={[]} wordforms={props.wordforms}/>
		   </span>
		  </td>
		  <td className="table-cell">
		   <span opt_features="[]" req_features='["PL","N"]'>
		    <Wordform features={['PL', 'N']} optional_features={[]} wordforms={props.wordforms}/>
		   </span>
		  </td>
		 </tr>
		 <tr>
		  ...
		  <td className="table-cell">
		   <span opt_features="[]" req_features='["ABL","SG","N"]'>
		    <Wordform features={['ABL', 'SG', 'N']} optional_features={[]} wordforms={props.wordforms}/>
		   </span>
		  </td>
		  <td className="table-cell">
		   <span opt_features="[]" req_features='["ABL","PL","N"]'>
		    <Wordform features={['ABL', 'PL', 'N']} optional_features={[]} wordforms={props.wordforms}/>
		   </span>
		  </td>
		 </tr>
		</table>
